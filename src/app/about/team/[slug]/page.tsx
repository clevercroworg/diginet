                ...
                <div className="flex flex-wrap items-center gap-4">
                  ...
                  {member.linkedin && (
                    <a
                      ...
                      className="inline-flex items-center gap-2 px-5 py-3 rounded-full bg-slate-800 text-slate-200 border border-slate-700 text-xs sm:text-sm font-semibold hover:bg-[#0A66C2] hover:text-white hover:border-[#0A66C2] transition-all"
                    >
